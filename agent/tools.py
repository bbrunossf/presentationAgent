...
class AgentTools:
    ...
    def save_agent_response(self, response, filepath: str = None):
        ...
        with open(filepath, 'w', encoding='utf-8') as f:
            json.dump(response, f, ensure_ascii=False, indent=2, default=json_serializer) #dump (sem s) salva direto em arquivo. O outro salva direto em memoria
    ...
    def query_database(self, query: str):
        ...
        try:
            ...
            return {"error": f"Erro ao executar consulta no banco de dados: {str(e)}"}
    ...
    def generate_sales_chart(self):
        ...
        try:
            ...
            data = self.query_database("SELECT month, sales FROM sales_data ORDER BY month")
    ...
    def get_sales_data(self):
        ...
        return self.query_database("SELECT month, sales FROM sales_data ORDER BY month")
